...
export default function Sidebar({ collections, handleAddCollection, handleCollectionClick, activeCollection}) {
  ...
  return (
    <aside className="sidebar-container" id="sidebar">
      <header className="sidebar-header">
        ...
        <div className="sidebar-header-profile-name-text">{profile.name}</div>
      </header>
      <nav className="sidebar-nav-container">
        ...
        {collections.map((collection, idx) => (
          <Collection key={idx} idx={idx} collection={collection} handleCollectionClick={handleCollectionClick} activeCollection={activeCollection} />
        ))}
      </nav>
    </aside>
  )
